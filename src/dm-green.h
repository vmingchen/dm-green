...
/* Context information needed by queued migration work */
struct migration_info {
    ...
    extent_t    veid_c;     /* virtual extent id mapped onto cache disk */
    extent_t    eid_c;      /* physical extent id on cache disk */
